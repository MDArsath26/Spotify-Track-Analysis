...
sp = spotipy.Spotify(auth_manager=SpotifyClientCredentials(
    client_id='a3ec1bc4fb5f47b58a3e11c5df226071',  # Replace with your Client ID
    client_secret='9d342488130f4f7e89df9707392f2328'  # Replace with your Client Secret
))

# Full track URL (example: Shape of You by Ed Sheeran)
track_url = "https://open.spotify.com/track/6g3pwMsCrqV5HcxF6p99GB"
